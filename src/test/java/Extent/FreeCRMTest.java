...
import com.relevantcodes.extentreports.LogStatus;
	public class FreeCRMTest {
		...
		public void setExtent(){
			...
			extent.addSystemInfo("Host Name", "bhimskr");
			extent.addSystemInfo("User Name", "bhimskr windowsMachine");
		...
		public void freeCrmTitleTest(){
			...
			Assert.assertEquals(title,"CRMPRO  - CRM software for customer relationship management, sales, and support1.");
		}
